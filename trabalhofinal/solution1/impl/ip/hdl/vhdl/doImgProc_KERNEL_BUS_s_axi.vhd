...
architecture behave of doImgProc_KERNEL_BUS_s_axi is
    ...
    constant ADDR_KERNEL_BASE : INTEGER := 16#20#;
    constant ADDR_KERNEL_HIGH : INTEGER := 16#3f#;
    ...
    -- memory signals
    signal int_kernel_address0 : UNSIGNED(2 downto 0);
    ...
    signal int_kernel_address1 : UNSIGNED(2 downto 0);
...
-- ----------------------- Memory logic ------------------
    -- kernel
    int_kernel_address0  <= SHIFT_RIGHT(UNSIGNED(kernel_address0), 2)(2 downto 0);
    ...
    int_kernel_address1  <= raddr(4 downto 2) when ar_hs = '1' else waddr(4 downto 2);
