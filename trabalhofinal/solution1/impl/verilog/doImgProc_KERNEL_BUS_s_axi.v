...
#(parameter
    ...
    input  wire                          RREADY,
    // user signals
    input  wire [4:0]                    kernel_address0,
...
//------------------------Parameter----------------------
localparam
    ADDR_KERNEL_BASE = 6'h20,
    ADDR_KERNEL_HIGH = 6'h3f,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
assign int_kernel_address1 = ar_hs? raddr[4:2] : waddr[4:2];
